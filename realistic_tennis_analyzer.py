...
JSON: {{"recommendation": "Победа [Игрок]/НЕТ", "confidence": 0.75, "reason": "Краткое обоснование на основе доступных данных"}}"""
...
JSON: {{"recommendation": "Победа [Игрок]/НЕТ", "confidence": 0.75, "reason": "Обоснование"}}"""
