...
class TelegramBot:
    ...
    def test_connection(self) -> bool:
        """
        Тестирует соединение с ботом (БЕЗ отправки сообщений)
        """
        try:
...
class TelegramChannelManager:
    ...
    def send_test_message(self) -> bool:
        """
        Отправляет тестовое сообщение в канал (ТОЛЬКО для ручного тестирования)
        """
        test_message = """
...
🔧 Это тестовое сообщение отправлено вручную
